...
func UpdateProduct(productName *string, price *int64, stripeKey string, description *string, rrp *int64, designer *string, fitNotes *string, productID string) (product *stripe.Product, err error) {
